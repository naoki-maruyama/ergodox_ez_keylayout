 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |L1    | LAlt |      | LAlt | MHEN |                                       | HEKN | RGui | RAlt |      |      |
 *   `----------------------------------'                                       `----------------------------------'
 *                                          ,-------------.       ,-------------.
 *                                          | Esc  |      |       |      |  Esc |
 *                                 ,--------|------|------|       |------+--------+------.
 *                                 |        |      |      |       |      |        |      |
 *                                 |L2/Space|Backsp|------|       |------|  Del   |Enter |
 *                                 |        |ace   | LGui |       |      |        |      |
 *                                 `----------------------'       `----------------------'
 */
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        // left hand
        KC_1,         KC_2,         KC_3,   KC_4,   KC_5,   KC_6,   KC_JYEN,
        KC_TAB,         KC_Q,         KC_W,   KC_E,   KC_R,   KC_T,   KC_RBRC,
        KC_LCTL,        KC_A,         KC_S,   KC_D,   KC_F,   KC_G,
        KC_LSFT,        CTL_T(KC_Z),  KC_X,   KC_C,   KC_V,   KC_B,   KC_HOME,
        LT(SYMB,KC_NO),KC_LALT,      KC_NO,  KC_LALT,KC_MHEN,
                                              KC_ESC,  KC_NO,
                                                              KC_NO,
                                               LT(MDIA,KC_SPC),KC_BSPC,KC_LGUI,
        // right hand
             KC_6,     KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS,             KC_EQL,
             KC_BSLS,       KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,             KC_LBRC,
                          KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,KC_QUOT,
             KC_END,KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,   MT(KC_RSFT,KC_RO),
                                  KC_HENK,  KC_RGUI,KC_RALT,KC_NO,          KC_NO,
             KC_NO,        KC_ESC,
             KC_NO,
             KC_NO,KC_DEL, KC_ENT
    ),
